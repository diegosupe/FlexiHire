...
<body>
    ...
    <div class="container-fluid degrade">
        <div class="row conteudo">
            ...
            <div class="col-md-5 col-sm-12 text-sm-start px-sm-5 px-0 text-center textoCont">
                <h2 class="">Encontre sua taxa!</h2>
            ...
            <div class="col-md-5 col-sm-12 imgCont">
                <img src="./imgs/Coffee shop-bro (4).png" class="img-fluid float-end imagemHeader ">
            </div>
            <div class="col-md-1 col-sm-12">
            </div>
        </div>
    </div>
    <div class="container-fluid fundoVerde">
            ...
            <div class="row my-4 mx-4">
                <div class="col-sm-3 mb-3 mb-sm-0">
                  <div class="card border-0 ">
                    <div class="card-body rounded-3 card1">
                      <h5 class="card-icon">
                ...
                <div class="col-sm-3 mb-3  mb-sm-0">
                  <div class="card border-0">
                    <div class="card-body rounded-3 card2 ">
                      <h5 class="card-icon">
                ...
                <div class="col-sm-3 mb-3 mb-sm-0">
                    <div class="card border-0 ">
                      <div class="card-body rounded-3 card3">
                        <h5 class="card-icon">
                  ...
                  <div class="col-sm-3 mb-3 mb-sm-0">
                    <div class="card border-0">
                      <div class="card-body rounded-3 card4">
                        <h5 class="card-icon">
    ...
    <div class="container-fluid degrade">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 my-sm-3 py-sm-3 text-sm-start text-center ps-sm-5 textoCadastro">
